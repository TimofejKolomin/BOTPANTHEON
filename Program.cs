...
(
    ...
    { 
        ...
        (
            text: "❗ Нажми на меня ❗",
            url: "https://github.com/TimofejKolomin/BOTPANTHEON/blob/main/Program.cs"
        )
    }
);
...
{
    await bot.SendTextMessageAsync(chatId: chatID, text: "Для того чтобы посмотреть команды бота - введите команду /help",replyToMessageId: update.Message.MessageId, cancellationToken: cancellationToken);
}
